  ...
  return (
    <div className="membership-container">
      ...
      <div className="kp-members-cart">
        ...
        <div className="kp-members-area">
          <div className="kp-members-area-image">
            <img src={member12} alt="member1" />
          </div>
          <h3>Dr. Nesar Ahmed, PhD</h3>
          <p>Member</p>
        </div>
      </div>
      <div className="kp-members-cart">
      ...
      <div className="kp-members-cart">
        <div className="kp-members-area">
          <div className="kp-members-area-image">
            <img src={exMember1} alt="member1" />
          </div>
          <h3>Late Mr. Amir Ali</h3>
          <p>Founding Vice President</p>
        </div>
        <div className="kp-members-area">
          <div className="kp-members-area-image">
